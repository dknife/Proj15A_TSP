...
void COpenGLMgr::placeCamera(GLdouble x, GLdouble y, GLdouble z, GLdouble tx, GLdouble ty, GLdouble tz, GLdouble ux, GLdouble uy, GLdouble uz) {
    glMatrixMode(GL_MODELVIEW);
	glLoadIdentity();
	gluLookAt(x,y,z, tx,ty,tz, ux,uy,uz);
}

void COpenGLMgr::setFog(GLfloat density, GLfloat *fogColor) {
    glEnable(GL_FOG);
